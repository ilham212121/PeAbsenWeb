...
def add_admin():
    ...
    cur.execute("INSERT INTO `login`(`nip`, `password`,`role` ) VALUES (%s,%s,%s) ",(nip,pswd,"admin"))
    mysql.connection.commit()
    return jsonify({"data":None,"meta":{"code":200,"message":"Berhasil ubah Data","status":"success"}})
...
def add_hrd():
    ...
    mysql.connection.commit()
    pswd = generate_password_hash("baru123")
    cur.execute("INSERT INTO `login`(`nip`, `password`,`role`) VALUES (%s,%s,%s) ",(nip,pswd,"hrd"))
    mysql.connection.commit()
    return jsonify({"data":None,"meta":{"code":200,"message":"Berhasil ubah Data","status":"success"}})
...
def add_karu():
    ...
    mysql.connection.commit()
    pswd = generate_password_hash("baru123")
    cur.execute("INSERT INTO `login`(`nip`, `password`,`role` ) VALUES (%s,%s,%s) ",(nip,pswd,"karu"))
    mysql.connection.commit()
    return jsonify({"data":None,"meta":{"code":200,"message":"Berhasil ubah Data","status":"success"}})
